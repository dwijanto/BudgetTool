...
Imports Npgsql
Imports securityTest.NpgsqlRoleProvider
...
Public Class NpgsqlMembershipProvider
    ...
    Public Overrides Function ChangePassword(ByVal username As String, ByVal oldPassword As String, ByVal newPassword As String) As Boolean
        ...
        Dim sqlstr As String = "Update users set passwd = @passwd,lastpasswordchangeddate=@lastpasswordchangeddate " & _
        ...
        cmd.Parameters.Add("@lastpasswordchangeddate", NpgsqlTypes.NpgsqlDbType.Date).Value = DateTime.Now
    ...
    Public Overrides Function CreateUser(ByVal username As String, ByVal password As String, ByVal email As String, ByVal passwordQuestion As String, ByVal passwordAnswer As String, ByVal isApproved As Boolean, ByVal providerUserKey As Object, ByRef status As System.Web.Security.MembershipCreateStatus) As System.Web.Security.MembershipUser
        ...
        If u Is Nothing Then
            ...
            cmd.Parameters.Add("@creationdate", NpgsqlTypes.NpgsqlDbType.Date).Value = createdate
            cmd.Parameters.Add("@lastpasswordchangeddate", NpgsqlTypes.NpgsqlDbType.Date).Value = createdate
            cmd.Parameters.Add("@lastactivitydate", NpgsqlTypes.NpgsqlDbType.Date).Value = createdate
            cmd.Parameters.Add("@applicationname", NpgsqlTypes.NpgsqlDbType.Varchar).Value = _ApplicationName
            cmd.Parameters.Add("@islockedout", NpgsqlTypes.NpgsqlDbType.Boolean).Value = False
            cmd.Parameters.Add("@lastlockedoutdate", NpgsqlTypes.NpgsqlDbType.Date).Value = createdate
            cmd.Parameters.Add("@failedpasswordattemptcount", NpgsqlTypes.NpgsqlDbType.Integer).Value = 0
            cmd.Parameters.Add("@failedpasswordattemptwindowstart", NpgsqlTypes.NpgsqlDbType.Date).Value = createdate
            cmd.Parameters.Add("@failedpasswordanswerattemptcount", NpgsqlTypes.NpgsqlDbType.Integer).Value = 0
            cmd.Parameters.Add("@failedpasswordanswerattemptwindowstart", NpgsqlTypes.NpgsqlDbType.Date).Value = createdate
    ...
    Public Overrides Function GetNumberOfUsersOnline() As Integer
        ...
        '    cmd.Parameters.Add("@comparedate", NpgsqlTypes.NpgsqlDbType.Date).Value = compareTime
        '    cmd.Parameters.Add("@applicationname", NpgsqlTypes.NpgsqlDbType.Varchar).Value = _ApplicationName
    ...
    Public Overrides Function GetUserNameByEmail(ByVal email As String) As String
        Dim conn As NpgsqlConnection = New NpgsqlConnection(connectionString)
        Dim cmd As NpgsqlCommand = New NpgsqlCommand("SELECT username FROM users  WHERE email = @Email AND ApplicationName = @ApplicationName", conn)
    ...
    Public Overrides Function ResetPassword(ByVal username As String, ByVal answer As String) As String
        ...
        Try
            ...
            updateCmd.Parameters.Add("@LastPasswordChangedDate", NpgsqlTypes.NpgsqlDbType.Date).Value = DateTime.Now
            updateCmd.Parameters.Add("@Username", NpgsqlTypes.NpgsqlDbType.Varchar).Value = username
            updateCmd.Parameters.Add("@ApplicationName", NpgsqlTypes.NpgsqlDbType.Varchar).Value = _ApplicationName
    ...
    Public Overrides Function ValidateUser(ByVal username As String, ByVal password As String) As Boolean
        ...
        Try
            ...
            If CheckPassword(password, pwd) Then
                ...
                Dim updateCmd As NpgsqlCommand = New NpgsqlCommand("update users set lastlogindate = @lastlogindate where username = @username and applicationname=@applicationname ", conn)
                updateCmd.Parameters.Add("@lastlogindate", NpgsqlTypes.NpgsqlDbType.Date).Value = DateTime.Now
                updateCmd.Parameters.Add("@username", NpgsqlTypes.NpgsqlDbType.Varchar).Value = username

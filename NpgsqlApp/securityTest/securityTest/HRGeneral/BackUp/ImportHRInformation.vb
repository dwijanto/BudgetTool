                    ...
                    For J = 14 To iRows
                        ...
                        If Not IsNothing(oSheet.Cells(J, i).value) Then
                            ...
                            If regionImport = RegionImportEnum.HK Then
                                ...
                                personjoindatecategoryid = DbAdapter1.getpersonjoindatecategoryid(categoryid, personjoindateid, deptid, CDbl(oSheet.Cells(J, 7).value.ToString), expat, EffectiveDateStart, EffectiveDateEnd)

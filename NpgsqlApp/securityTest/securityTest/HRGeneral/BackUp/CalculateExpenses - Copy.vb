...
Public Class CalculateExpenses
    ...
    Private Sub buildQuery(ByRef sb As StringBuilder)
        ...
        sqlstr = "select * from  fgetpersoncategory(" & DateFormatyyyyMMdd(BeginingYear) & "," & dbtools1.RegionId & "," & myverid & ") as a(personjoindatecategoryid integer,personname character varying, othername character varying,joindate date,title character varying, category character varying,dept character varying,expat boolean,enddate date,headcount numeric,personjoindateid integer,effectivedatestart date,effectivedateend date);"
        sb.Append(sqlstr)

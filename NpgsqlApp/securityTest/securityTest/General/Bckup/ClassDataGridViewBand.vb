...
Public Class ClassDataGridViewBand
    Inherits Form
...
#Region "Form setup"
    ...
    Private Sub InitializeComponent()
        ...
        '
        'ClassDataGridViewBand
        '
        Me.AutoSize = True
        Me.ClientSize = New System.Drawing.Size(614, 360)
        Me.Controls.Add(Me.FlowLayoutPanel2)
        Me.Name = "ClassDataGridViewBand"
...
#Region "setup DataGridView"
    ...
    Protected Sub AddButton(ByVal button As Button, _
        ...
        button.TabIndex = FlowLayoutPanel2.Controls.Count
...
#End Region
    ...
    Private Sub dataGridView_CellFormatting(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellFormattingEventArgs) Handles dataGridView.CellFormatting
        If e.ColumnIndex = dataGridView.Columns(3).Index AndAlso (e.Value IsNot Nothing) Then
